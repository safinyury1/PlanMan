...
## Установка и запуск
### Архив проекта приложил с письмом на электронную почту!
...
1. **credentials.json**: Получите этот файл в [Google Cloud Console](https://console.cloud.google.com/), создав проект и включив **Google Calendar API** (тип приложения: *Desktop App*). Поместите его в корень проекта.
2. **.env**: Создайте файл `.env` в корневой папке и добавьте туда ваш токен от [@BotFather](https://t.me/BotFather):
   ```env
...
### 6. Использование
1. Перейдите в Telegram по ссылке [@plan_man_01bot](https://t.me/plan_man_01bot) и введите команду `/start`.
2. Следуйте инструкциям бота для авторизации вашего Google Календаря.
> **ВАЖНО:** Для работы OAuth-авторизации в Google Cloud ваша почта должна быть добавлена в список тестеров проекта. **Пожалуйста, сообщите мне вашу почту перед началом тестирования! Telegram:(@remzzik), либо на E-mail: (safin15092005@mail.ru)
